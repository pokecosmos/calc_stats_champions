...
function mega_button(){
	...
	if((p=="ニャース")||(p=="ニャース (通常)")||(p=="ニャース (アローラ)")||(p=="ニャース (ガラル)")){
		...
		visi(2, "通常", "ガラル");
		if(p=="マタドガス"){
			document.nForm.elements['pokename'].value = "マタドガス (通常)";
		}
	}else if((p=="マッギョ")||(p=="マッギョ (通常)")||(p=="マッギョ (ガラル)")){
		visi(2, "通常", "ガラル");
		if(p=="マッギョ"){
			document.nForm.elements['pokename'].value = "マタドガス (通常)";
		}
	...
	}else if((p=="ギルガルド")||(p=="ギルガルド (シールド)")||(p=="ギルガルド (ブレード)")){
		visi(2, "シールド", "ブレード");
		if(p=="ギルガルド"){
	...
	}else if((p=="バケッチャ")||(p=="バケッチャ (小玉)")||(p=="バケッチャ (中玉)")||(p=="バケッチャ (大玉)")||(p=="バケッチャ (ギガ玉)")){
		visi(4, "小玉", "中玉", "大玉", "ギガ玉");
		if(p=="バケッチャ"){
			document.nForm.elements['pokename'].value = "バケッチャ (中玉)";
		}
	}else if((p=="パンプジン")||(p=="パンプジン (小玉)")||(p=="パンプジン (中玉)")||(p=="パンプジン (大玉)")||(p=="パンプジン (ギガ玉)")){
		visi(4, "小玉", "中玉", "大玉", "ギガ玉");
		if(p=="パンプジン"){
			document.nForm.elements['pokename'].value = "パンプジン (中玉)";
		}
//メガシンカ-----------------------------------------------------------------------------------------------
	}else if((p=="フシギバナ")||(p=="メガフシギバナ")||(p=="カメックス")||(p=="メガカメックス")
	       ||(p=="スピアー")||(p=="メガスピアー")||(p=="ピジョット")||(p=="メガピジョット")
	       ||(p=="ピクシー")||(p=="メガピクシー")||(p=="フーディン")||(p=="メガフーディン")
	       ||(p=="ウツボット")||(p=="メガウツボット")||(p=="ゲンガー")||(p=="メガゲンガー")
	       ||(p=="ガルーラ")||(p=="メガガルーラ")||(p=="スターミー")||(p=="メガスターミー")
	       ||(p=="カイロス")||(p=="メガカイロス")||(p=="ギャラドス")||(p=="メガギャラドス")
	       ||(p=="プテラ")||(p=="メガプテラ")||(p=="カイリュー")||(p=="メガカイリュー")
	       ||(p=="メガニウム")||(p=="メガメガニウム")||(p=="オーダイル")||(p=="メガオーダイル")
	       ||(p=="デンリュウ")||(p=="メガデンリュウ")||(p=="ハガネール")||(p=="メガハガネール")
	       ||(p=="ハッサム")||(p=="メガハッサム")||(p=="ヘラクロス")||(p=="メガヘラクロス")
	       ||(p=="エアームド")||(p=="メガエアームド")||(p=="ヘルガー")||(p=="メガヘルガー")
	       ||(p=="バンギラス")||(p=="メガバンギラス")||(p=="ジュカイン")||(p=="メガジュカイン")
	       ||(p=="バシャーモ")||(p=="メガバシャーモ")||(p=="ラグラージ")||(p=="メガラグラージ")
	       ||(p=="サーナイト")||(p=="メガサーナイト")||(p=="ヤミラミ")||(p=="メガヤミラミ")
	       ||(p=="クチート")||(p=="メガクチート")||(p=="ボスゴドラ")||(p=="メガボスゴドラ")
	       ||(p=="チャーレム")||(p=="メガチャーレム")||(p=="ライボルト")||(p=="メガライボルト")
	       ||(p=="サメハダー")||(p=="メガサメハダー")||(p=="バクーダ")||(p=="メガバクーダ")
	       ||(p=="チルタリス")||(p=="メガチルタリス")||(p=="ジュペッタ")||(p=="メガジュペッタ")
	       ||(p=="チリーン")||(p=="メガチリーン")||(p=="オニゴーリ")||(p=="メガオニゴーリ")
	       ||(p=="ボーマンダ")||(p=="メガボーマンダ")||(p=="メタグロス")||(p=="メガメタグロス")
	       ||(p=="ラティアス")||(p=="メガラティアス")||(p=="ラティオス")||(p=="メガラティオス")
	       ||(p=="レックウザ")||(p=="メガレックウザ")||(p=="ムクホーク")||(p=="メガムクホーク")
	       ||(p=="ミミロップ")||(p=="メガミミロップ")||(p=="ガブリアス")||(p=="メガガブリアス")
	       ||(p=="ユキノオー")||(p=="メガユキノオー")||(p=="エルレイド")||(p=="メガエルレイド")
	       ||(p=="ユキメノコ")||(p=="メガユキメノコ")||(p=="ヒードラン")||(p=="メガヒードラン")
	       ||(p=="ダークライ")||(p=="メガダークライ")||(p=="エンブオー")||(p=="メガエンブオー")
	       ||(p=="ドリュウズ")||(p=="メガドリュウズ")||(p=="タブンネ")||(p=="メガタブンネ")
	       ||(p=="ペンドラー")||(p=="メガペンドラー")||(p=="ズルズキン")||(p=="メガズルズキン")
	       ||(p=="シビルドン")||(p=="メガシビルドン")||(p=="シャンデラ")||(p=="メガシャンデラ")
	       ||(p=="ゴルーグ")||(p=="メガゴルーグ")||(p=="ブリガロン")||(p=="メガブリガロン")
	       ||(p=="マフォクシー")||(p=="メガマフォクシー")||(p=="ゲッコウガ")||(p=="メガゲッコウガ")
	       ||(p=="カエンジシ")||(p=="メガカエンジシ")||(p=="ニャオニクス")||(p=="メガニャオニクス")
	       ||(p=="カラマネロ")||(p=="メガカラマネロ")||(p=="ガメノデス")||(p=="メガガメノデス")
	       ||(p=="ドラミドロ")||(p=="メガドラミドロ")||(p=="ルチャブル")||(p=="メガルチャブル")
	       ||(p=="ディアンシー")||(p=="メガディアンシー")||(p=="ケケンカニ")||(p=="メガケケンカニ")
	       ||(p=="グソクムシャ")||(p=="メガグソクムシャ")||(p=="ジジーロン")||(p=="メガジジーロン")
	       ||(p=="マギアナ")||(p=="メガマギアナ")||(p=="ゼラオラ")||(p=="メガゼラオラ")
	       ||(p=="タイレーツ")||(p=="メガタイレーツ")||(p=="シャリタツ")||(p=="メガシャリタツ")
	       ||(p=="スコヴィラン")||(p=="メガスコヴィラン")||(p=="キラフロル")||(p=="メガキラフロル")
	       ||(p=="セグレイブ")||(p=="メガセグレイブ")
	       ||(p=="アブソル")||(p=="メガアブソル")
	       ||(p=="ルカリオ")||(p=="メガルカリオ")
           ){
		visi(2, "通常", "メガ");
	}else if((p=="リザードン")||(p=="メガリザードンＸ")||(p=="メガリザードンＹ")){
		visi(3, "通常", "メガＸ", "メガＹ");
	}else if((p=="ライチュウ")||(p=="メガライチュウＸ")||(p=="メガライチュウＹ")||(p=="ライチュウ (通常)")||(p=="ライチュウ (アローラ)")){
		visi(4, "通常", "アローラ", "メガＸ", "メガＹ");
	}else if((p=="ヤドラン")||(p=="メガヤドラン")||(p=="ヤドラン (通常)")||(p=="ヤドラン (ガラル)")){
		visi(3, "通常", "ガラル", "メガ");
	}else if((p=="ミュウツー")||(p=="メガミュウツーＸ")||(p=="メガミュウツーＹ")){
		visi(3, "通常", "メガＸ", "メガＹ");
	}else if((p=="フラエッテ")||(p=="メガフラエッテ")||(p=="フラエッテ (永遠)")){
		visi(2, "永遠", "メガ");
	}else if((p=="ジガルデ")||(p=="メガジガルデ")||(p=="ジガルデ (10%)")||(p=="ジガルデ (50%)")||(p=="ジガルデ (パーフェクト)")){
		visi(4, "10%", "50%", "100%", "メガ");
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
	}else{
		visi(0);
...
function megachange(num){
	...
	//通常orメガシンカ
 	}else if((p=="フシギバナ")||(p=="メガフシギバナ")
		 	||(p=="カメックス")||(p=="メガカメックス")||(p=="スピアー")||(p=="メガスピアー")
  			||(p=="ピジョット")||(p=="メガピジョット")||(p=="ピクシー")||(p=="メガピクシー")
  			||(p=="フーディン")||(p=="メガフーディン")||(p=="ウツボット")||(p=="メガウツボット")
  			||(p=="ゲンガー")||(p=="メガゲンガー")||(p=="ガルーラ")||(p=="メガガルーラ")
  			||(p=="スターミー")||(p=="メガスターミー")||(p=="カイロス")||(p=="メガカイロス")
  			||(p=="ギャラドス")||(p=="メガギャラドス")||(p=="プテラ")||(p=="メガプテラ")
  			||(p=="カイリュー")||(p=="メガカイリュー")||(p=="キラフロル")||(p=="メガキラフロル")
  			||(p=="オーダイル")||(p=="メガオーダイル")||(p=="デンリュウ")||(p=="メガデンリュウ")
  			||(p=="ハガネール")||(p=="メガハガネール")||(p=="ハッサム")||(p=="メガハッサム")
  			||(p=="ヘラクロス")||(p=="メガヘラクロス")||(p=="エアームド")||(p=="メガエアームド")
  			||(p=="ヘルガー")||(p=="メガヘルガー")||(p=="バンギラス")||(p=="メガバンギラス")
  			||(p=="ジュカイン")||(p=="メガジュカイン")||(p=="バシャーモ")||(p=="メガバシャーモ")
  			||(p=="ラグラージ")||(p=="メガラグラージ")||(p=="サーナイト")||(p=="メガサーナイト")
  			||(p=="ヤミラミ")||(p=="メガヤミラミ")||(p=="クチート")||(p=="メガクチート")
  			||(p=="ボスゴドラ")||(p=="メガボスゴドラ")||(p=="チャーレム")||(p=="メガチャーレム")
  			||(p=="ライボルト")||(p=="メガライボルト")||(p=="サメハダー")||(p=="メガサメハダー")
  			||(p=="バクーダ")||(p=="メガバクーダ")||(p=="チルタリス")||(p=="メガチルタリス")
  			||(p=="ジュペッタ")||(p=="メガジュペッタ")||(p=="チリーン")||(p=="メガチリーン")
  			||(p=="オニゴーリ")||(p=="メガオニゴーリ")||(p=="メタグロス")||(p=="メガメタグロス")
  			||(p=="ラティアス")||(p=="メガラティアス")||(p=="ボーマンダ")||(p=="メガボーマンダ")
  			||(p=="ラティオス")||(p=="メガラティオス")||(p=="レックウザ")||(p=="メガレックウザ")
  			||(p=="ムクホーク")||(p=="メガムクホーク")||(p=="ミミロップ")||(p=="メガミミロップ")
  			||(p=="ガブリアス")||(p=="メガガブリアス")||(p=="ユキノオー")||(p=="メガユキノオー")
  			||(p=="エルレイド")||(p=="メガエルレイド")||(p=="ユキメノコ")||(p=="メガユキメノコ")
  			||(p=="ヒードラン")||(p=="メガヒードラン")||(p=="ダークライ")||(p=="メガダークライ")
  			||(p=="エンブオー")||(p=="メガエンブオー")||(p=="ドリュウズ")||(p=="メガドリュウズ")
  			||(p=="タブンネ")||(p=="メガタブンネ")||(p=="ペンドラー")||(p=="メガペンドラー")
  			||(p=="ズルズキン")||(p=="メガズルズキン")||(p=="シビルドン")||(p=="メガシビルドン")
  			||(p=="シャンデラ")||(p=="メガシャンデラ")||(p=="ゴルーグ")||(p=="メガゴルーグ")
  			||(p=="ブリガロン")||(p=="メガブリガロン")||(p=="マフォクシー")||(p=="メガマフォクシー")
  			||(p=="ゲッコウガ")||(p=="メガゲッコウガ")||(p=="カエンジシ")||(p=="メガカエンジシ")
  			||(p=="ニャオニクス")||(p=="メガニャオニクス")||(p=="カラマネロ")||(p=="メガカラマネロ")
  			||(p=="ガメノデス")||(p=="メガガメノデス")||(p=="ドラミドロ")||(p=="メガドラミドロ")
  			||(p=="ルチャブル")||(p=="メガルチャブル")||(p=="ディアンシー")||(p=="メガディアンシー")
  			||(p=="ケケンカニ")||(p=="メガケケンカニ")||(p=="グソクムシャ")||(p=="メガグソクムシャ")
  			||(p=="ジジーロン")||(p=="メガジジーロン")||(p=="マギアナ")||(p=="メガマギアナ")
  			||(p=="ゼラオラ")||(p=="メガゼラオラ")||(p=="タイレーツ")||(p=="メガタイレーツ")
  			||(p=="スコヴィラン")||(p=="メガスコヴィラン")||(p=="シャリタツ")||(p=="メガシャリタツ")
  			||(p=="セグレイブ")||(p=="メガセグレイブ")
  			||(p=="アブソル")||(p=="メガアブソル")
  			||(p=="ルカリオ")||(p=="メガルカリオ")
 			){
